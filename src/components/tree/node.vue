...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            showArrow () {
                return (this.data[this.childrenKey] && this.data[this.childrenKey].filter((item)=>item.hide!=true).length) || ('loading' in this.data && !this.data.loading);
            },
            showLoading () {
